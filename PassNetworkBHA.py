# -*- coding: utf-8 -*-
"""
Created on Sun Jan 31 21:30:49 2021
...
a = plt.scatter(passer_avg.x, passer_avg.y, s=120, c=b,facecolor='none',lw=1,
                cmap='cool', alpha=1, zorder=2, vmin=-0.06, vmax=0.1,
                marker='h')
...
legend1 = ax.legend(*a.legend_elements(num=5), frameon=False, ncol=6,
...
plt.text(0,101,"Minutes 0-45 (First Substitution)", color='#132257',
               fontsize=6)
plt.text(90.5,101,"@trevillion_", color='#132257', fontsize=6)
plt.text(94.7,9,"+0.10", color='#132257', fontsize=5)
plt.text(72.5,9,"-0.06", color='#132257', fontsize=5)
plt.text(84.2,9,"EPV", color='#132257', fontsize=5)
plt.text(0,112,"Tottenham Hotspur PV Pass Network", 
             fontsize=12, color="#132257", fontweight = 'bold')
plt.text(0,106,"0-1 vs. Brighton (A) | Premier League 2020-21", 
             fontsize=8, color="#132257", fontweight = 'bold')
plt.savefig('C:/Users/Matt/Documents/Football Data/matplotlib/Tottenham/BHA(A) 31.01.21/PassNetwork.png', 
